...
if (stringEntry=== "")
{
    alert("You must put in a phrase, then select the button.");
}
else
{
   var intVowels=0;
   ...
   $("output").value= "There are " +intVowels+ " vowels in the phrase above.";
}
};
...
$("output").value= "There are "+ intConsonants+ " consonants in the phrase above.";
}
};
